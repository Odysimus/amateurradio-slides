...
\includegraphics[height=.9\textheight]{cw.png}
\end{frame}
...
\begin{frame}
\frametitle{AM}
Amplitude Modulation or AM, works by keeping the frequency of a signal steady and varying the amplitude or intensity of the wave. For sounds, we simply add the sound wave to the radio wave.
\end{frame}

\begin{frame}
\frametitle{AM picture}
\includegraphics[height=.9\textheight]{Amfm.png}
\end{frame}
